                ...
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 d-none d-md-block">
                            <div class="logo">
                                <a href="index.html"><img src="<c:url value='/template/web/assets/img/logo/logo.png'/>" alt=""></a>
                            </div>
                        </div>
                        <div class="col-xl-9 col-lg-9 col-md-9">
                            <div class="header-banner f-right ">
                                <img src="<c:url value='/template/web/assets/img/gallery/header_card.png' />" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <nav>                  
                                    <ul id="navigation">
                                        ...
                                        <c:if test="${not empty USERMODEL}">
                                        	...
                                        	<li><a href="<c:url value='/thoat?action=logout'/> ">Logout</a></li>
